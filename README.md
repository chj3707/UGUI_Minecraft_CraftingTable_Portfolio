...
+ #### **_인벤토리, 작업대 슬롯 클릭 IPointerClickHandler 사용_**
    + _슬롯 클릭 상황 별 처리_
        + _Non Dragging_
            + _빈 슬롯 :: 함수 종료_
            + _아이템 슬롯_
                + _좌 클릭 :: 슬롯의 모든 아이템 드래그_
                + _우 클릭 :: 슬롯의 아이템 절반 드래그_
        + _Dragging_
            + _빈 슬롯_
                + _좌 클릭 :: 드래그 중인 아이템 모두 드랍_
                + _우 클릭 :: 드래그 중인 아이템 1개 드랍_
            + _아이템 슬롯_
                + _좌 클릭 :: 슬롯에 최대 개수 만큼 드랍, 나머지 드래그_
                + _우 클릭 :: 슬롯에 아이템 1개 드랍, 나머지 드래그_
                + _다른 아이템 클릭 :: 슬롯 아이템과 스왑_
